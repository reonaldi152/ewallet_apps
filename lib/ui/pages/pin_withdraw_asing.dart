...
class PinWithdrawAsing extends StatefulWidget {
  const PinWithdrawAsing({Key? key, this.amount, this.symbols, this.country})
      : super(key: key);
  ...
  @override
  State<PinWithdrawAsing> createState() => _PinWithdrawAsingState();
}

class _PinWithdrawAsingState extends State<PinWithdrawAsing> {
  ...
  postWithdraw({symbols, amount, country, pin}) async {
    WithdrawService()
        .postWithdrawAsing(amount, symbols, country, pin)
      ...
      if (value?['message'].toString() == "Withdraw Success") {
        Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => WithdrawAsingConfirm(
                symbols: symbols,
                amount: amount,
                country: country,
